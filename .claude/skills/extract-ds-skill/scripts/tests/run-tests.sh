...
# Test 45: pass — craft file symlinked to the canonical asset (byte-identical
...
# Test 46: fail — craft file present and routed but paraphrased during persist
...
# Test 47: absent file SKIPs, never FAILs — re-use Test 4's on-the-fly produced
...
# Test 48: meta-mode skips DESIGN_CRAFT entirely. The check is produced-mode

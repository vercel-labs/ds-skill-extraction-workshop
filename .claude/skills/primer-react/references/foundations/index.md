...
- [primitives](./primitives.md) — Primer Primitives package — design tokens consumed as CSS variables, the base/functional split, and the three-attribute color-mode/theming contract.

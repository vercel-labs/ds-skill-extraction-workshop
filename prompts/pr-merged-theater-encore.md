...
- Run the dev server, watch the full sequence in both color modes — checks resolving, the box opening, the flip to merged — and fix what you see before you finish.
